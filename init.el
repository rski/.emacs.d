...
(setq user-full-name "Romanos Skiadas"
      ...
      default-input-method "greek" ;; C-\ will switch between
      ;; default-input-method and the actual kb layout this makes resizing not
      ;; trunkate the frame size and create gaps underneath it in awesome
