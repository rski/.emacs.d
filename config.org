...
#+BEGIN_SRC emacs-lisp
  (use-package magit
    ...
    (evil-leader/set-key "gP" 'magit-pull-popup)
    (evil-leader/set-key "gc" 'magit-commit-popup)
    (evil-leader/set-key "gbb" 'magit-branch-and-checkout)
    (evil-leader/set-key "gbc" 'magit-checkout)
    :ensure t)
...
(evil-leader/set-key "fed" 'visit-config)
#+END_SRC
